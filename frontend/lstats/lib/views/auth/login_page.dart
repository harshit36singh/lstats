...
import 'package:lstats/views/auth/pages/Homescreen.dart';
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            SizedBox(height: 15),
            Center(
              child: field("Password", Icon(Icons.password), true, password),
            ),
            SizedBox(height: 9),
            auth.isLoading
                    ...
                    onPressed: () async {
                      try {
                        ...
                        if (auth.token != null ) {
                          ...
                          Navigator.push(context,MaterialPageRoute(builder:(context) =>HomeScreen(username: email.text, displayName: "User")));
                        }
                      } catch (e) {
